...
interface Props
  extends HTMLAttributes<ReactElement>,
    ButtonHTMLAttributes<ReactElement> {
...
const btnStyle = {
  ...
  square:
    'text-base min-w-[48px] py-[14px] rounded-lg px-2 leading-[1.25] text-dark hover:bg-primary hover:text-white hover:opacity-100 lg:px-2 lg:text-[16px]',
